...
- [UI design guidelines](20260915_energyatlas_ui_design_guidelines.md): current visual and interaction guidance supplied by the user on 2026-09-15, kept as supplied (decision 0009).
