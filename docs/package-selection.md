...
| Typeface (added 2026-09-15, decision 0010) | @fontsource-variable/geist 5.3.0; @fontsource-variable/geist-mono 5.3.0 only if Geist Mono is confirmed | OFL-1.1 | `geist` 1.7.2 (Vercel; Next.js oriented, 8.0 MB unpacked); Google Fonts CDN rejected | Self-hosted variable WOFF2 bundled by Vite, subset loading by `unicode-range`, 181 kB unpacked, no runtime network |
